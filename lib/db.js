        ...
        return new Promise((resolve, reject) => {
            ...
            request.onsuccess = (event) => {
                ...
                if (cursor) {
                    ...
                    // R5-5b NOTA CONSCIA (deciso in R4, documentato 2026-08-19):
                    // le righe robots_disallowed restano NEL set Retry Failed,
                    // a differenza di skipped_invalid_url. Asimmetria voluta:
                    // un URL strutturalmente invalido non può MAI riuscire
                    // (retry = puro spreco), mentre robots.txt è una policy
                    // del sito che PUÒ cambiare — e il costo del retry è un
                    // singolo fetch di robots.txt (cache 24h TTL) prima di
                    // fermarsi di nuovo, non un crawl completo.
